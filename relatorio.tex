...
\begin{figure}[htbp]
    ...
    \subfloat[united]{\includegraphics[scale=0.45]{images/new/wave_nand.png}} \\
    \subfloat[separated]{\includegraphics[scale=0.45]{images/new/wave_sep_nand.png}}
    \label{fig:wave-nand}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Waveforms da simulação transiente da porta.}
    \subfloat[united]{\includegraphics[scale=0.45]{images/new/wave_nor.png}} \\
    \subfloat[separated]{\includegraphics[scale=0.45]{images/new/wave_sep_nor.png}}
    \label{fig:wave-nor}
\end{figure}
